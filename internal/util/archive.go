...
func ExtractTar(r io.Reader, destDir string) error {
	...
	for {
		...
		// Only directories and regular files are restored. Symlinks and other
		// non-regular entry types are intentionally skipped to prevent
		// symlink-based path-traversal attacks during extraction, and files are
		// written with fixed permissions rather than the source mode. This means
		// a restore is not a byte-for-byte mirror; see the "Known limitations"
